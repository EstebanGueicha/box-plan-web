...
export const RenameGroup = (props) => {
  ...
  return (
    <>
      <Modal show={renameGroup} onHide={() => loading ? setRenameGroup(prev => !prev) : null} centered>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit((e) => { sendData(e) })}>
            ...
            <div className='button-container'>
              <Button variant='outline-secondary' onClick={() => setRenameGroup(prev => !prev)} disabled={loading}>
                Cerrar
              </Button>
