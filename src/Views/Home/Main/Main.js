        ...
        <Row className="justify-content-center">
          <Col lg={8}>
            <div className="main-div aboutus">
              ...
              <p>
                Tus atletas podrán usar la APP para ver las planificaciones y no depender de otras
                Aplicaciones. El coach dispone de la WEB para que sea más sencillo gestionar los
                equipos y también esta la posibilidad de utilizar la APP con funciones similares.
        ...
        <Row>
          ...
          <Col lg={4}>
            <div className="main-div">
              ...
              <p>
                Para cada sesión de Weightlifting se puede calcular el peso que el atleta desee en
                ese momento.
              </p>
            </div>
          </Col>
          <Col lg={4}>
            <div className="main-div">
              ...
              <h3>List</h3>
              <p>
                El grupo podrá subir los tiempos de las rutinas para observar como les fue en el día
          ...
          <Col lg={4}>
            <div className="main-div">
              ...
              <h3>Coachs</h3>
              <p>
                El coach va a poder crear distintos grupos y enviar distintias planificaciones para
                cada team.
              </p>
            </div>
          </Col>
          <Col lg={4}>
            <div className="main-div">
              ...
              <h3>Atletas</h3>
              <p>
                Los atletas puede pertenecer a distintos teams, ya sea para su box, o weigthlifting,
                natación, running, etc.
              </p>
            </div>
          </Col>
          <Col lg={4}>
            <div className="main-div">
              ...
              <h3>Developers</h3>
              <p>
                Contanos si tenés alguna mejora o problema para poder ayudar y progresar juntos.
              </p>
            </div>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col lg={8}>
            <div className="main-div aboutus">
              ...
              <p>
                Contanos que te parece Box Plan. Si tenés alguna sugerencia o crítica será bien
                recibida. Estamos trabajando para poder darte más beneficios cada día.
              </p>
